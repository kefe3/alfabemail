...
- Penguen tasarımı sadeleştirildi: yalnızca elinde tek bir mail zarfı taşır; kapıya yaklaşınca kapı açılır, penguen içeri girer ve kapı üzerinde `alfabe.co` yazısı görünür.
